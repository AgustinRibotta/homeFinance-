...
import com.homeFinance.homeFinance.repository.BalanceRepository;
...
public class PeriodServiceImpl implements PeriodService {
    ...
    private final HouseholdSavingsRepository householdSavingsRepository;
    private final PeriodMapper periodMapper;

    public PeriodServiceImpl(PeriodRepository periodRepository, HouseholdRepository householdRepository, UserRepository userRepository, BalanceRepository balanceRepository, HouseholdSavingsRepository householdSavingsRepository, PeriodMapper periodMapper) {
        this.periodRepository = periodRepository;
        this.householdRepository = householdRepository;
        this.userRepository = userRepository;
        this.balanceRepository = balanceRepository;
        this.householdSavingsRepository = householdSavingsRepository;
    ...
    public PeriodResponse closePeriod(UUID periodId) {
        ...
        HouseholdSavings savings = householdSavingsRepository
                .findByHouseholdId(period.getHousehold().getId())
                .orElseGet(() -> {
                    HouseholdSavings newSavings = new HouseholdSavings();
                    newSavings.setHousehold(period.getHousehold());
                    newSavings.setTotalSavings(BigDecimal.ZERO);
                    return newSavings;
                });

        savings.setTotalSavings(savings.getTotalSavings().add(totalBalance));
        householdSavingsRepository.save(savings);
